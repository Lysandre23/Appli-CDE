        ...
        <View style={[styles.main,{backgroundColor: props.color}]}>
            ...
            <View style={styles.mini}>
                <View style={{display: 'flex', justifyContent: 'space-evenly', alignItems: 'center'}}>
                    <MiniNavbarIcon goto="Clubs" type="icon" name="futbol-o" title="Clubs" color="#2ECC71"/>
                    <MiniNavbarIcon goto="Goodies" type="icon" name="shopping-bag" title="Goodies" color="#F39C12"/>
                </View>
                <View style={{display: 'flex', justifyContent: 'space-evenly', alignItems: 'center'}}>
                    <MiniNavbarIcon goto="PSN" type="logo" title="PSN" color="#2ECC71"/>
                    <MiniNavbarIcon goto="Partenaires" type="icon" name="handshake-o" title="Partenaires" color="#E74C3C"/>
                </View> 
            </View>
            :
            <View></View>}
